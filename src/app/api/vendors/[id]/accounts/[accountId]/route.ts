...
const updateVendorAccountSchema = z.object({
  ...
  avgMonthlyPayment: z.union([z.string(), z.number()]).optional().nullable(),
  ...
  try {
    ...
    const updatedAccount = await prisma.vendorAccount.update({
      ...
      data: {
        ...
        initialValue: data.initialValue !== undefined ? (data.initialValue != null ? data.initialValue : null) : undefined,
        creditLimit: data.creditLimit !== undefined ? (data.creditLimit != null ? data.creditLimit : null) : undefined,
        avgMonthlyPayment: data.avgMonthlyPayment !== undefined ? (data.avgMonthlyPayment != null ? data.avgMonthlyPayment : null) : undefined,
